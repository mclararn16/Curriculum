  ...
  return (
    <main className={styles.contentPage}>
      ...
      <section className={styles.detailSection}>
        ...
        <Image src="/imagens/sweetly-pedidos.jpeg" alt="Switly" width={200} height={433} className={styles.switlyImage} />
        <Image src="/imagens/sweetly-bemvindos.jpeg" alt="Switly" width={200} height={433} className={styles.switlyImage} />
        <Image src="/imagens/sweetly-criar.jpeg" alt="Switly" width={200} height={433} className={styles.switlyImage} />
        <p>
