    ...
    <main className={styles.contentPage}>
      ...
      <section className={styles.detailSection}>
        ...
        <div>
          ...
          <Image src="/imagens/foto-frente.jpeg" alt="Projeto SWITAB" width={145} height={200} className={styles.academicImage} />
          <Image src="/imagens/foto-costas.jpeg" alt="Projeto SWITAB" width={145} height={200} className={styles.academicImage} />
          <Image src="/imagens/liferay.jpeg" alt="ET Liferay" width={145} height={200} className={styles.academicImage} />
        
          <p>Ao longo da minha trajetória acadêmica, busquei ir além da sala de aula participando de atividades extracurriculares que me aproximaram do ambiente profissional.
          <p>No segundo período, tive a oportunidade de participar da mentoria da Avanade, que foi meu primeiro contato mais próximo com esse universo e um ótimo ponto de partida para entender como funciona o dia a dia na área de tecnologia.</p>
